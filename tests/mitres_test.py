...
def test_split_shots_task_gen():
    ...
    circ_1_test_result = [circ_shots for i, circ_shots in enumerate(test_result[0]) if test_result[1][i]==0]
    shot_total = 0
    ...
    circ_2_test_result = [circ_shots for i, circ_shots in enumerate(test_result[0]) if test_result[1][i]==1]
    shot_total = 0
...
def test_group_shots_task_gen():
    ...
    merged_results = task(([circ_1_results_1, circ_1_results_2, circ_2_results_1, circ_3_results_1, circ_3_results_2, circ_3_results_3], [0,0,1,2,2,2]))
